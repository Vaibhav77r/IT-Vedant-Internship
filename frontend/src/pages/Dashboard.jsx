    ...
    <div style={styles.page}>
      ...
      <aside style={styles.sidebar}>
        ...
        <nav>
          ...
          <div style={styles.navItem}>📄 Estimates</div>
...
const styles = {
  ...
  navItem: {
    ...
    marginBottom: '4px', fontSize: '0.9rem', color: '#c4c4d4'
  },
  logoutBtn: {
    marginTop: 'auto', padding: '10px', background: '#dc2626', color: '#fff',
  ...
  card: {
    padding: '1.2rem', borderRadius: '12px', display: 'flex',
  ...
  infoBox: {
    ...
    borderLeft: '4px solid #4f46e5', fontSize: '0.95rem'
  }
};