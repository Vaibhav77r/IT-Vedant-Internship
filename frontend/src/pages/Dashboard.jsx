      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          {[
            ...
            { label: 'Invoices',      value: '0', icon: '🧾', color: '#dcfce7', path: '/dashboard' },
...
const styles = {
  ...
  infoBox:   { background:'#fff', padding:'1.2rem', borderRadius:'12px', borderLeft:'4px solid #4f46e5', fontSize:'0.95rem' }
};
